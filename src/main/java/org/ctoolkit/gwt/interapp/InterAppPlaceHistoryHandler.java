 ...
 * the License.
 */
package org.ctoolkit.gwt.interapp;
 ...
 */
public class InterAppPlaceHistoryHandler
{
    private static final Logger log = Logger.getLogger( InterAppPlaceHistoryHandler.class.getName() );
     ...
     * @param moduleName
     */
    public InterAppPlaceHistoryHandler( PlaceHistoryMapper mapper, String moduleName )
    {
        this( mapper, ( Historian ) GWT.create( DefaultHistorian.class ), moduleName );
    }
     ...
     * @param moduleName
     */
    public InterAppPlaceHistoryHandler( PlaceHistoryMapper mapper, Historian historian, String moduleName )
    {
        this.mapper = mapper;
                                         ...
                                         Place defaultPlace )
    {
        ...
        return new HandlerRegistration()
        {
            ...
            {
                InterAppPlaceHistoryHandler.this.defaultPlace = Place.NOWHERE;
                InterAppPlaceHistoryHandler.this.placeController = null;
